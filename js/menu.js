$(document).ready(function() {
    ...
    $('.btn').click(function() {
        var images =["url(./images/sandwich.jpg)","url(./images/burgerset.jpg)","url(./images/grills.jpeg)","url(./images/seafood.jpeg)"],
            title=["Sandwich","Beef Burger","Beef Grills","Seafood"],
